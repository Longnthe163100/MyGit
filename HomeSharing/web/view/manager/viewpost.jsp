                                ...
                                <div class="col-lg-6">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">                                   
                                            ...
                                            <a class="btn btn-primary" href="managerviewpostdetail?post_id=${x.post_id}">Chi tiết →</a>
                                        </div>
                                    </div>  
                                </div>
                            </c:if>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="form-group">
                                        <form action="managercreatepost" method="get">
        ...
        <nav aria-label="Pagination">
            ...
            <ul class="pagination justify-content-center my-4">
                <li class="page-item disabled"></li>
                    ...
                    <li class="page-item"><a class="page-link" href="managerviewpost?page=${i}">${i}</a></li>
                    </c:forEach>
