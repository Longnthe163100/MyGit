    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="homemanager"><i class='app-menu__icon bx bx-tachometer'></i><span
                            class="app-menu__label">Bảng điều khiển</span></a></li>
                <li><a class="app-menu__item" href="homemanager?action=houselist   "><i
                    ...
                    <div class="tile">
                        <div class="tile-body">
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    <a class="btn btn-add btn-sm" href="homemanager?action=insert" title="Thêm"><i class="fas fa-plus"></i>
                                        Thêm nhà mới</a>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <form action="homemanager?action=updatehouse" method="POST">
