...
/*                overflow-y: auto;
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <a href="${pageContext.request.contextPath}/managerviewpost" class="btn btn-secondary back-button">Trở về</a>
                ...
                <div class="col-md-4">
                    ...
                    <c:if test="${post_detail.account_id == account.account_id}"><form action="managereditpost" method="get"><button <link rel="stylesheet" href="managereditpost"/>Chỉnh sửa</button></form></c:if>
        </div>
    </body>
</html>
