    ...
    <body>
        ...
        <header class="py-5 bg-light border-bottom mb-4">
            ...
            <div class="col-md-8 col-md-offset-2">
                <form action="admineditpost" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="status" id="status">
                            <option name="status" value="${post_detail.status == 1 ? 1 : 0}">${post_detail.status == 1 ? "Hiển thị" : "Không hiển thị"}</option>
                            <option name="status" value="${post_detail.status != 1 ? 1 : 0}">${post_detail.status != 1 ? "Hiển thị" : "Không hiển thị"}</option>
                    ...
                    <div class="form-group">
                        ...
                        <button class="btn btn-default" ><a href="adminviewpostdetail?post_id=${post_detail.post_id}">Hủy</a>
                        </button>
                    </div>
                </form>
            </div>
