        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="housemanager?action=houselist"><b>Danh sách nhà</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
            <div class="row">
                    ...
                    <div class="tile">
                        <div class="tile-body">
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    <a class="btn btn-add btn-sm" href="housemanager?action=houseinsert" title="Thêm"><i class="fas fa-plus"></i>
                                        Thêm nhà mới</a>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <form action="housemanager?action=updatehouse" method="POST" enctype="multipart/form-data">
                                <input  class="form-control" type="text" id="house_id" readonly name="house_id" hidden="" >
                                    ...
                                    <tbody>
                                        <c:forEach items="${house}" var="h">
                                            <tr>
                                                ...
                                                <td>${h.describe}</td>
                                                <td>${h.city}</td>
                                                <td>${h.status == "true" ? "Còn phòng" : "Hết phòng "}</td>
                                                <td><img src="${h.img}" alt="" width="100px;"></td>

                                                <td>
                                                    <button onclick="setId(${h.house_id})" class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp"
                                                            data-toggle="modal" data-target="#ModalUP${h.house_id}"><i class="fas fa-edit"></i>
                                                    </button>
                                                    <a class="btn btn-add btn-sm" href="housemanager?action=roomlist&houseid=${h.house_id}" >Xem</a>
                                                </td>
                                            </tr>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input class="form-control" type="text" name="address${h.house_id}" required value="${h.address}">
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label class="control-label">Giá</label>
                                                                <input class="form-control" type="number" name="price${h.house_id}" required min="0" value="${h.price}">
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label class="control-label">Tỉnh/Thành</label>
                                                                <input class="form-control" type="text" name="city${h.house_id}" value="${h.city}">
                                                            </div>

                                                            <div class="form-group col-md-6">
                                                                <label class="control-label">Mô tả</label>
                                                                <input class="form-control" type="text" name="describe${h.house_id}" value="${h.describe}">
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label class="control-label">Trạng thái</label>
                                                                <br>
                                                                <input type="radio" style="height: 15px; width: 15px" ${h.status?'checked':''} name="status${h.house_id}" value="true">Còn phòng
                                                                <br>
                                                                <input type="radio" style="height: 15px; width: 15px" ${h.status eq false?'checked':''}  name="status${h.house_id}" value="false">Hết phòng
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <div id="myfileupload">
                                                                    <input type="file"  name="img${h.house_id}" />
                                                                </div>
                                                                <div id="thumbbox">
