...
public class EditPostManagerController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("./view/manager/editpost.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        post.setPhone(phone);
        post.setPrice(price);
        postDBContext.update(post);
        response.sendRedirect("managerviewpostdetail?post_id="+post.getPost_id());
    }
}
