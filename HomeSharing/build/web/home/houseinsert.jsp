        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    <li class="breadcrumb-item"><a href="housemanager?action=houselist">Danh sách nhà</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            <form class="row" action="housemanager?action=inserthouse" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group  col-md-3">
                                    ...
                                    <input class="form-control" placeholder="Giá... *" required="" min="0" name="price" type="number">
                                </div>
                                <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div id="boxchoice">
                                        <a href="javascript:" class="Choicefile"><i class="fas fa-cloud-upload-alt"></i><input type="file"  name="img" /> Chọn ảnh</a>
