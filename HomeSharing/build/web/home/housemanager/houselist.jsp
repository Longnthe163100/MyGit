...
<html lang="en">
    ...
    <head>
        <title>Danh sách nhà được quản lý</title>
        <meta charset="utf-8">
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="housemanagement"><b>Danh sách nhà</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
            <div class="row">
                    ...
                    <div class="tile">
                        <div class="tile-body">
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    <a class="btn btn-add btn-sm" href="housemanagement?action=insert" title="Thêm"><i class="fas fa-plus"></i>
                                        Thêm nhà mới</a>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <form action="housemanagement?action=updatehouse" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input class="form-control" type="text" readonly name="house_id" value="${h.house_id}">
                                                            </div>
                ...
                jQuery(".trash").click(function () {
                    swal({
                        ...
                        buttons: ["Hủy bỏ", "Đồng ý"],
                            ...
                            .then((willDelete) => {
                                if (willDelete) {
                                    window.location = "housemanagement?action=deletehouse&house_id=" + $(this).attr("value");
